      ...
      <article className="section">
        <div className="container">
          ...
          <p>
            ...
            officia fuga omnis dolores excepturi praesentium! quam perspiciatis,
            dicta in beatae. Voluptas vitae rem, molestias, quaerat modi hic
            deserunt aliquam quis similique alias totam.
          </p>
        </div>
      </article>
          ...
          <div className="reasons">
            <div className="reason">
              ...
              <p>
                ...
                in dolor, nec orci. Sapien, ut cras in risus nibh nunc. Non,
                elit habitasse nisl convallis molestie auctor.
              </p>
            </div>
            <div className="reason">
              <h3>Reason 2</h3>
